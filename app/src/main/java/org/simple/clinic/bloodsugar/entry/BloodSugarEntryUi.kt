...
interface BloodSugarEntryUi {
  ...
  fun showBloodSugarHighError(measurementType: BloodSugarMeasurementType, unitPreference: UnitPreference)
  fun showBloodSugarLowError(measurementType: BloodSugarMeasurementType, unitPreference: UnitPreference)
